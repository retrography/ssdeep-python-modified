...
static struct PyModuleDef _cffi_module_def = {
  ...
  "_ssdeep_cffi_8a9054b9x627c7d55",
  NULL,
  -1,
  _cffi_methods,
  NULL, NULL, NULL, NULL
...
PyMODINIT_FUNC
PyInit__ssdeep_cffi_8a9054b9x627c7d55(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_ssdeep_cffi_8a9054b9x627c7d55(void)
{
  PyObject *lib;
  lib = Py_InitModule("_ssdeep_cffi_8a9054b9x627c7d55", _cffi_methods);
  if (lib == NULL)
    return;
  if (0 < 0 || _cffi_init() < 0)
    return;
